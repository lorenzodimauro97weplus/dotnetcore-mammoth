...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal
{
    internal class InternalDocumentConverter
    {
        ...
        {
            return util.PassThroughException.unwrap(new InternalDocumentConverter__Anonymous_1(stream, this));
        }
        public results.InternalResult<string> convertToHtml(java.io.File file)
        {
            return util.PassThroughException.unwrap(new InternalDocumentConverter__Anonymous_3(file, this));
        }
        public results.InternalResult<string> convertToHtml(Mammoth.Couscous.java.util.Optional<java.nio.file.Path> path, archives.Archive zipFile)
        {
            ...
            return docx.DocumentReader.readDocument(path, zipFile).flatMap(new InternalDocumentConverter__Anonymous_6(conversionOptions)).map(new InternalDocumentConverter__Anonymous_7()).map(new InternalDocumentConverter__Anonymous_8()).map(new InternalDocumentConverter__Anonymous_9());
        }
        public Mammoth.Couscous.java.util.Optional<string> readEmbeddedStyleMap(archives.Archive zipFile)
        {
            return util.PassThroughException.wrap(new InternalDocumentConverter__Anonymous_10(zipFile));
        }
        public results.InternalResult<string> extractRawText(java.io.InputStream stream)
        {
            return util.PassThroughException.unwrap(new InternalDocumentConverter__Anonymous_12(stream, this));
        }
        public results.InternalResult<string> extractRawText(java.io.File file)
        {
            return util.PassThroughException.unwrap(new InternalDocumentConverter__Anonymous_14(file, this));
        }
        ...
        {
            return docx.DocumentReader.readDocument(path, zipFile).map(new InternalDocumentConverter__Anonymous_15());
        }
        ...
        {
            var zipFile = archives.InMemoryArchive.fromStream(stream);
            try
            {
                return function.apply(zipFile);
            }
        ...
        {
            return java.lang.String.join("", util.Iterables.lazyMap(nodes, new InternalDocumentConverter__Anonymous_16()));
        }
        public static string extractRawText(documents.DocumentElement node)
        {
            return util.Casts.tryCast<documents.Text>(typeof(documents.Text), node).map(new InternalDocumentConverter__Anonymous_17()).orElseGet(new InternalDocumentConverter__Anonymous_20(node));
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal
{
    internal class InternalDocumentConverter__Anonymous_2 : Mammoth.Couscous.java.util.function.Function<archives.Archive, results.InternalResult<string>>
    {
        ...
        public results.InternalResult<string> apply(archives.Archive zipFile)
        {
            return _this_org__zwobble__mammoth__internal__InternalDocumentConverter.convertToHtml(java.util.Optional.of(_file.toPath()), zipFile);
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal
{
    internal class InternalDocumentConverter__Anonymous_13 : Mammoth.Couscous.java.util.function.Function<archives.Archive, results.InternalResult<string>>
    {
        ...
        public results.InternalResult<string> apply(archives.Archive zipFile)
        {
            return _this_org__zwobble__mammoth__internal__InternalDocumentConverter.extractRawText(java.util.Optional.of(_file.toPath()), zipFile);
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal
{
    internal class InternalDocumentConverter__Anonymous_20 : Mammoth.Couscous.java.util.function.Supplier<string>
    {
        ...
        public string get()
        {
            var children = util.Casts.tryCast<documents.HasChildren>(typeof(documents.HasChildren), _node).map(new InternalDocumentConverter__Anonymous_18()).orElse(util.Lists.list<documents.DocumentElement>());
            var suffix = util.Casts.tryCast<documents.Paragraph>(typeof(documents.Paragraph), _node).map(new InternalDocumentConverter__Anonymous_19()).orElse("");
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.archives
{
    internal class ZipPaths
    {
        ...
        {
            var nonEmptyPaths = util.Lists.eagerFilter(java.util.Arrays.asList(paths), new ZipPaths__Anonymous_0());
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.conversion
{
    internal class DocumentToHtml
    {
        ...
        internal DocumentToHtml(DocumentToHtmlOptions options, Mammoth.Couscous.java.util.List<documents.Comment> comments)
        {
            ...
            _comments = util.Maps.toMapWithKey(comments, new DocumentToHtml__Anonymous_0());
        }
        ...
        {
            return util.Lists.eagerMap(noteReferences, new DocumentToHtml__Anonymous_1(document));
        }
        ...
        {
            var documentConverter = new DocumentToHtml(options, util.Lists.list<documents.Comment>());
        ...
        public Mammoth.Couscous.java.util.List<html.HtmlNode> convertToHtml(documents.Document document, DocumentToHtml__Context context)
        {
            ...
            var noteNodes = notes.isEmpty() ? util.Lists.list<html.HtmlNode>() : util.Lists.list(html.Html.element("ol", util.Lists.eagerMap(notes, new DocumentToHtml__Anonymous_2(this, context))));
            var commentNodes = _referencedComments.isEmpty() ? util.Lists.list<html.HtmlNode>() : util.Lists.list(html.Html.element("dl", util.Lists.eagerFlatMap(_referencedComments, new DocumentToHtml__Anonymous_3(this, context))));
            return util.Lists.eagerConcat(mainBody, noteNodes, commentNodes);
        }
        public html.HtmlNode convertToHtml(documents.Note note, DocumentToHtml__Context context)
        {
            ...
            var backLink = html.Html.collapsibleElement("p", util.Lists.list(html.Html.text(" "),
            html.Html.element("a", util.Maps.map("href", $"#{referenceId}"), util.Lists.list(html.Html.text("↑")))));
            return html.Html.element("li", util.Maps.map("id", id), util.Lists.eagerConcat(noteBody, util.Lists.list(backLink)));
        }
        public Mammoth.Couscous.java.util.List<html.HtmlNode> convertToHtml(DocumentToHtml__ReferencedComment referencedComment, DocumentToHtml__Context context)
        {
            ...
            var backLink = html.Html.collapsibleElement("p", util.Lists.list(html.Html.text(" "),
            html.Html.element("a", util.Maps.map("href", $"#{generateReferenceHtmlId("comment", commentId)}"), util.Lists.list(html.Html.text("↑")))));
            return util.Lists.list(html.Html.element("dt", util.Maps.map("id", generateReferentHtmlId("comment", commentId)), util.Lists.list(html.Html.text($"Comment {referencedComment._label}"))), html.Html.element("dd", util.Lists.eagerConcat(body, util.Lists.list(backLink))));
        }
        ...
        {
            return util.Lists.eagerFlatMap(elements, new DocumentToHtml__Anonymous_4(this, context));
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.conversion
{
    ...
    internal class DocumentToHtml__ElementConverterVisitor : documents.DocumentElementVisitor<Mammoth.Couscous.java.util.List<html.HtmlNode>, DocumentToHtml__Context>
    {
        ...
        {
            var mapping = _this_org__zwobble__mammoth__internal__conversion__DocumentToHtml._styleMap.getTableHtmlPath(table).orElse(styles.HtmlPath_static.element("table"));
        ...
        {
            var bodyIndex = util.Iterables.findIndex(table.getChildren(), new DocumentToHtml__Anonymous_12(this)).orElse(table.getChildren().size());
            if (bodyIndex == 0)
            {
            ...
            else
            {
                ...
                return util.Lists.list(html.Html.element("thead", headRows), html.Html.element("tbody", bodyRows));
            }
        }
        public bool isHeader(documents.DocumentElement child)
        {
            return util.Casts.tryCast<documents.TableRow>(typeof(documents.TableRow), child).map(new DocumentToHtml__Anonymous_13()).orElse(false);
        }
        public Mammoth.Couscous.java.util.List<html.HtmlNode> visit(documents.TableRow tableRow, DocumentToHtml__Context context)
        {
            return util.Lists.list(html.Html.element("tr", _this_org__zwobble__mammoth__internal__conversion__DocumentToHtml.convertChildrenToHtml(tableRow, context)));
        }
        public Mammoth.Couscous.java.util.List<html.HtmlNode> visit(documents.TableCell tableCell, DocumentToHtml__Context context)
        {
            ...
            return util.Lists.list(html.Html.element(tagName, attributes, util.Lists.cons(html.Html._FORCE_WRITE, _this_org__zwobble__mammoth__internal__conversion__DocumentToHtml.convertChildrenToHtml(tableCell, context))));
        }
        public Mammoth.Couscous.java.util.List<html.HtmlNode> visit(documents.Hyperlink hyperlink, DocumentToHtml__Context context)
        {
            ...
            var link = generateHref(hyperlink);

            if (link.Contains("http", StringComparison.InvariantCultureIgnoreCase) || link.Contains("mailto", StringComparison.InvariantCultureIgnoreCase))
                attributes = util.Maps.mutableMap("href", link);
            else
            {
                attributes = util.Maps.mutableMap("onclick", $"""document.getElementById('{link.Remove(0,1)}').scrollIntoView();""");
                attributes.put("role", "link");
                attributes.put("tabindex", "0");
                attributes.put("class", "button text-body-size");
            }
            hyperlink.getTargetFrame().ifPresent(new DocumentToHtml__Anonymous_14(attributes));
            return util.Lists.list(html.Html.collapsibleElement("a", attributes, _this_org__zwobble__mammoth__internal__conversion__DocumentToHtml.convertChildrenToHtml(hyperlink, context)));
        }
        ...
        {
            return util.Lists.list(html.Html.element("a", util.Maps.map("id", _this_org__zwobble__mammoth__internal__conversion__DocumentToHtml.generateId(bookmark.getName())), util.Lists.list(html.Html._FORCE_WRITE)));
        }
        public Mammoth.Couscous.java.util.List<html.HtmlNode> visit(documents.NoteReference noteReference, DocumentToHtml__Context context)
        {
            ...
            return util.Lists.list(html.Html.element("sup", util.Lists.list(html.Html.element("a", util.Maps.map("href", $"#{noteAnchor}", "id", noteReferenceAnchor), util.Lists.list(html.Html.text($"[{_this_org__zwobble__mammoth__internal__conversion__DocumentToHtml._noteReferences.size()}]"))))));
        }
        ...
        {
            return image.getContentType().map(new DocumentToHtml__Anonymous_19(_this_org__zwobble__mammoth__internal__conversion__DocumentToHtml, image)).orElse(util.Lists.list<html.HtmlNode>());
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.conversion
{
    internal class DocumentToHtml__Anonymous_5 : Mammoth.Couscous.java.util.function.Supplier<Mammoth.Couscous.java.util.List<html.HtmlNode>>
    {
        ...
        public Mammoth.Couscous.java.util.List<html.HtmlNode> get()
        {
            ...
            return _this_org__zwobble__mammoth__internal__conversion__DocumentToHtml._preserveEmptyParagraphs ? util.Lists.cons(html.Html._FORCE_WRITE, content) : content;
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.conversion
{
    internal class DocumentToHtml__Anonymous_16 : Mammoth.Couscous.java.util.function.Supplier<Mammoth.Couscous.java.util.List<html.HtmlNode>>
    {
        ...
        public Mammoth.Couscous.java.util.List<html.HtmlNode> get()
        {
            ...
            var comment = util.Maps.lookup(_this_org__zwobble__mammoth__internal__conversion__DocumentToHtml._comments, commentId).orElseThrow(new DocumentToHtml__Anonymous_15(commentId));
            ...
            return util.Lists.list(html.Html.element("a", util.Maps.map("href", $"#{_this_org__zwobble__mammoth__internal__conversion__DocumentToHtml.generateReferentHtmlId("comment", commentId)}", "id", _this_org__zwobble__mammoth__internal__conversion__DocumentToHtml.generateReferenceHtmlId("comment", commentId)), util.Lists.list(html.Html.text(label))));
        }
    }
}
    ...
    internal class DocumentToHtml__Anonymous_19 : Mammoth.Couscous.java.util.function.Function<string, Mammoth.Couscous.java.util.List<html.HtmlNode>>
    {
        ...
        public Mammoth.Couscous.java.util.List<html.HtmlNode> apply(string contentType)
        {
            try
            {
                ...
                return util.Lists.list(html.Html.element("img", attributes));
            }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.conversion
{
    internal class DocumentToHtmlOptions
    {
        ...
        {
            var styleMap = styles.StyleMap._EMPTY;
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.conversion
{
    internal class DocumentToHtmlOptions__Anonymous_1 : images.ImageConverter__ImgElement
    {
        ...
        {
            var base64 = util.Base64Encoding.streamToBase64(new DocumentToHtmlOptions__Anonymous_0(image));
            var src = $"data:{image.getContentType()};base64,{base64}";
            return util.Maps.map("src", src);
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.documents
{
    internal class Hyperlink : DocumentElement, HasChildren
    {
        ...
        {
            return new Hyperlink(java.util.Optional.of(href), java.util.Optional.empty<string>(), targetFrame, children);
        }
        ...
        {
            return new Hyperlink(java.util.Optional.empty<string>(), java.util.Optional.of(anchor), targetFrame, children);
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.documents
{
    internal class Notes
    {
        ...
        {
            _notes = util.Maps.eagerMapValues(util.Maps.toMultiMapWithKey(notes, new Notes__Anonymous_0()), new Notes__Anonymous_2());
        }
        public Mammoth.Couscous.java.util.Optional<Note> findNote(NoteType noteType, string noteId)
        {
            return util.Maps.lookup(_notes, noteType).flatMap(new Notes__Anonymous_3(noteId));
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.documents
{
    internal class Notes__Anonymous_2 : Mammoth.Couscous.java.util.function.Function<Mammoth.Couscous.java.util.List<Note>, Mammoth.Couscous.java.util.Map<string, Note>>
    {
        ...
        {
            return util.Maps.toMapWithKey(notesOfType, new Notes__Anonymous_1());
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.documents
{
    internal class Notes__Anonymous_3 : Mammoth.Couscous.java.util.function.Function<Mammoth.Couscous.java.util.Map<string, Note>, Mammoth.Couscous.java.util.Optional<Note>>
    {
        ...
        {
            return util.Maps.lookup(notesOfType, _noteId);
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class CommentXmlReader
    {
        ...
        {
            return results.InternalResult.flatMap(element.findChildren("w:comment"), new CommentXmlReader__Anonymous_0(this));
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class ContentTypes
    {
        ...
        public Mammoth.Couscous.java.util.Optional<string> findContentType(string path)
        {
            ...
            {
                return util.Maps.lookup(_overrides, path);
            }
            else
            {
                var extension = util.Paths.getExtension(path);
                if (_extensionDefaults.containsKey(extension))
                {
                    return util.Maps.lookup(_extensionDefaults, extension);
                }
                else
                {
                    return util.Maps.lookup(_imageExtensions, extension.ToLower()).map(new ContentTypes__Anonymous_0());
                }
            }
        }
    }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class ContentTypesXml
    {
        ...
        {
            return util.Maps.toMap(children, new ContentTypesXml__Anonymous_0());
        }
        public static Mammoth.Couscous.java.util.Map__Entry<string, string> readDefault(xml.XmlElement element)
        {
            return util.Maps.entry(element.getAttribute("Extension"), element.getAttribute("ContentType"));
        }
        public static Mammoth.Couscous.java.util.Map<string, string> readOverrides(xml.XmlElementList children)
        {
            return util.Maps.toMap(children, new ContentTypesXml__Anonymous_1());
        }
        public static Mammoth.Couscous.java.util.Map__Entry<string, string> readOverride(xml.XmlElement element)
        {
            return util.Maps.entry(util.Strings.trimLeft(element.getAttribute("PartName"), '/'), element.getAttribute("ContentType"));
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class DocumentReader
    {
        public static results.InternalResult<documents.Document> readDocument(Mammoth.Couscous.java.util.Optional<java.nio.file.Path> path, archives.Archive zipFile)
        {
            ...
            return results.InternalResult.flatMap(readNotes(partReader, partPaths), readComments(partReader, partPaths), new DocumentReader__Anonymous_1(partReader, partPaths));
        }
        ...
        {
            var targets = util.Lists.eagerMap(relationships.findTargetsByType(relationshipType), new DocumentReader__Anonymous_3(basePath));
            var validTargets = util.Lists.eagerFilter(targets, new DocumentReader__Anonymous_4(archive));
            return util.Lists.tryGetFirst(validTargets).orElse(fallbackPath);
        }
        ...
        {
            return partReader.readPart(partPaths.getComments(), new DocumentReader__Anonymous_5(), java.util.Optional.of(results.InternalResult.success(util.Lists.list<documents.Comment>())));
        }
        ...
        {
            return results.InternalResult.map(partReader.readPart(partPaths.getFootnotes(), new DocumentReader__Anonymous_6(), java.util.Optional.of(results.InternalResult.success(util.Lists.list<documents.Note>()))), partReader.readPart(partPaths.getEndnotes(), new DocumentReader__Anonymous_7(), java.util.Optional.of(results.InternalResult.success(util.Lists.list<documents.Note>()))), new DocumentReader__Anonymous_8()).map(new DocumentReader__Anonymous_9());
        }
        ...
        {
            var parts = archives.ZipPaths.splitPath(name);
            return archives.ZipPaths.joinPath(new string[]
            {
                parts.getDirname(),
                "_rels",
                $"{parts.getBasename()}.rels"
            });
        }
        public static Mammoth.Couscous.java.util.Optional<xml.XmlElement> tryParseOfficeXml(archives.Archive zipFile, string name)
        {
            return util.PassThroughException.wrap(new DocumentReader__Anonymous_15(zipFile, name));
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class DocumentReader__Anonymous_1 : Mammoth.Couscous.java.util.function.BiFunction<documents.Notes, Mammoth.Couscous.java.util.List<documents.Comment>, results.InternalResult<documents.Document>>
    {
        ...
        {
            return _partReader.readPart(_partPaths.getMainDocument(), new DocumentReader__Anonymous_0(notes, comments), java.util.Optional.empty<results.InternalResult<documents.Document>>());
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class DocumentReader__Anonymous_3 : Mammoth.Couscous.java.util.function.Function<string, string>
    {
        ...
        {
            return util.Strings.trimLeft(archives.ZipPaths.joinPath(new string[]
            {
                _basePath,
                target
            }), '/');
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class EmbeddedStyleMap
    {
        ...
        {
            var parser = new xml.parsing.XmlParser(_RELATIONSHIPS_NAMESPACES);
            var relationships = parser.parseStream(archives.Archives.getInputStream(archive, _RELATIONSHIPS_PATH));
            var relationship = xml.XmlNodes.element("Relationship", util.Maps.map("Id", "rMammothStyleMap", "Type", "http://schemas.zwobble.org/mammoth/style-map", "Target", _ABSOLUTE_STYLE_MAP_PATH));
        ...
        {
            var parser = new xml.parsing.XmlParser(_CONTENT_TYPES_NAMESPACES);
            var contentTypes = parser.parseStream(archives.Archives.getInputStream(archive, _CONTENT_TYPES_PATH));
            var @override = xml.XmlNodes.element("Override", util.Maps.map("PartName", _ABSOLUTE_STYLE_MAP_PATH, "ContentType", "text/prs.mammoth.style-map"));
        ...
        {
            var index = util.Iterables.findIndex(parent.getChildren(), new EmbeddedStyleMap__Anonymous_2(element, identifyingAttribute));
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class EmbeddedStyleMap__Anonymous_2 : Mammoth.Couscous.java.util.function.Predicate<xml.XmlNode>
    {
        ...
        {
            return util.Casts.tryCast<xml.XmlElement>(typeof(xml.XmlElement), child).map(new EmbeddedStyleMap__Anonymous_1(_element, _identifyingAttribute)).orElse(false);
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class NotesXmlReader
    {
        ...
        {
            var elements = util.Iterables.lazyFilter(element.findChildren($"w:{_tagName}"), new NotesXmlReader__Anonymous_0(this));
            return results.InternalResult.flatMap(elements, new NotesXmlReader__Anonymous_1(this));
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class Numbering
    {
        ...
        {
            return util.Maps.lookup(_numbering, numId).flatMap(new Numbering__Anonymous_0(level));
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class Numbering__Anonymous_0 : Mammoth.Couscous.java.util.function.Function<Mammoth.Couscous.java.util.Map<string, documents.NumberingLevel>, Mammoth.Couscous.java.util.Optional<documents.NumberingLevel>>
    {
        ...
        {
            return util.Maps.lookup(levels, _level);
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class NumberingXml
    {
        ...
        {
            return util.Maps.toMap(children, new NumberingXml__Anonymous_0());
        }
        public static Mammoth.Couscous.java.util.Map__Entry<string, Mammoth.Couscous.java.util.Map<string, documents.NumberingLevel>> readAbstractNum(xml.XmlElement element)
        {
            ...
            return util.Maps.entry(abstractNumId, readAbstractNumLevels(element));
        }
        ...
        {
            return util.Maps.toMap(element.findChildren("w:lvl"), new NumberingXml__Anonymous_1());
        }
        public static Mammoth.Couscous.java.util.Map__Entry<string, documents.NumberingLevel> readAbstractNumLevel(xml.XmlElement element)
        {
            ...
            var isOrdered = !numFmt.equals(java.util.Optional.of("bullet"));
            return util.Maps.entry(levelIndex, new documents.NumberingLevel(levelIndex, isOrdered));
        }
        ...
        {
            return util.Maps.toMap(numElements, new NumberingXml__Anonymous_2(abstractNums));
        }
        public static Mammoth.Couscous.java.util.Map__Entry<string, Mammoth.Couscous.java.util.Map<string, documents.NumberingLevel>> readNum(xml.XmlElement numElement, Mammoth.Couscous.java.util.Map<string, Mammoth.Couscous.java.util.Map<string, documents.NumberingLevel>> abstractNums)
        {
            ...
            return util.Maps.entry(numId, util.Maps.lookup(abstractNums, abstractNumId).get());
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class OfficeXml
    {
        ...
        {
            var parser = new xml.parsing.XmlParser(_XML_NAMESPACES);
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class OfficeXml__Anonymous_1 : xml.XmlNodeVisitor<Mammoth.Couscous.java.util.List<xml.XmlNode>>
    {
        public Mammoth.Couscous.java.util.List<xml.XmlNode> visit(xml.XmlElement element)
        {
            ...
            {
                var collapsedElement = new xml.XmlElement(element.getName(), element.getAttributes(), util.Lists.eagerFlatMap(element.getChildren(), new OfficeXml__Anonymous_0()));
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class PathRelativeFileReader : FileReader
    {
        ...
        public static Mammoth.Couscous.java.util.Optional<java.net.URI> asAbsoluteUri(string uriString)
        {
            try
            {
                var uri = new java.net.URI(uriString);
                return uri.isAbsolute() ? java.util.Optional.of(uri) : java.util.Optional.empty<java.net.URI>();
            }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class ReadResult
    {
        ...
        {
            var results = util.Lists.eagerMap(iterable, function);
            return new ReadResult(util.Lists.eagerFlatMap(results, new ReadResult__Anonymous_0()), util.Lists.eagerFlatMap(results, new ReadResult__Anonymous_1()), util.Iterables.lazyFlatMap(results, new ReadResult__Anonymous_2()));
        }
        ...
        {
            return new ReadResult(util.Lists.list(function.apply(first.getValue(), second._elements)), second._extra, util.Iterables.lazyConcat(first.getWarnings(), second._warnings));
        }
        public static ReadResult success(documents.DocumentElement element)
        {
            return success(util.Lists.list(element));
        }
        ...
        {
            return withWarning(util.Lists.list(element), warning);
        }
        public static ReadResult withWarning(Mammoth.Couscous.java.util.List<documents.DocumentElement> elements, string warning)
        {
            return new ReadResult(elements, util.Lists.list<documents.DocumentElement>(), util.Lists.list(warning));
        }
        ...
        {
            return new ReadResult(util.Lists.list(function.apply(_elements)), _extra, _warnings);
        }
        public ReadResult flatMap(Mammoth.Couscous.java.util.function.Function<Mammoth.Couscous.java.util.List<documents.DocumentElement>, ReadResult> function)
        {
            ...
            return new ReadResult(result._elements, util.Lists.eagerConcat(_extra, result._extra), util.Iterables.lazyConcat(_warnings, result._warnings));
        }
        public ReadResult toExtra()
        {
            return new ReadResult(util.Lists.list<documents.DocumentElement>(), util.Lists.eagerConcat(_extra, _elements), _warnings);
        }
        public ReadResult appendExtra()
        {
            return new ReadResult(util.Lists.eagerConcat(_elements, _extra), util.Lists.list<documents.DocumentElement>(), _warnings);
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class Relationships
    {
        ...
        {
            _targetsByRelationshipId = util.Maps.toMap(relationships, new Relationships__Anonymous_0());
            _targetsByType = util.Maps.toMultiMap(relationships, new Relationships__Anonymous_1());
        }
        public string findTargetByRelationshipId(string relationshipId)
        {
            return util.Maps.lookup(_targetsByRelationshipId, relationshipId).orElseThrow(new Relationships__Anonymous_2(relationshipId));
        }
        public Mammoth.Couscous.java.util.List<string> findTargetsByType(string type)
        {
            return util.Maps.lookup(_targetsByType, type).orElse(util.Lists.list<string>());
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class Relationships__Anonymous_0 : Mammoth.Couscous.java.util.function.Function<Relationship, Mammoth.Couscous.java.util.Map__Entry<string, string>>
    {
        ...
        {
            return util.Maps.entry(relationship.getRelationshipId(), relationship.getTarget());
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class Relationships__Anonymous_1 : Mammoth.Couscous.java.util.function.Function<Relationship, Mammoth.Couscous.java.util.Map__Entry<string, string>>
    {
        public Mammoth.Couscous.java.util.Map__Entry<string, string> apply(Relationship relationship)
        {
            return util.Maps.entry(relationship.getType(), relationship.getTarget());
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class RelationshipsXml
    {
        ...
        {
            return new Relationships(util.Lists.eagerMap(element.findChildren("relationships:Relationship"), new RelationshipsXml__Anonymous_0()));
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class StatefulBodyXmlReader
    {
        ...
        {
            _IMAGE_TYPES_SUPPORTED_BY_BROWSERS = util.Sets.set(new string[]
            {
                "image/png",
                "image/gif",
                "image/jpeg",
        ...
        {
            return util.Iterables.tryGetLast(util.Iterables.lazyFilter<StatefulBodyXmlReader__ComplexField, StatefulBodyXmlReader__HyperlinkComplexField>(_complexFieldStack, typeof(StatefulBodyXmlReader__HyperlinkComplexField))).map(new StatefulBodyXmlReader__Anonymous_1());
        }
        ...
        public ReadResult readElements(java.lang.Iterable<xml.XmlNode> nodes)
        {
            return ReadResult.flatMap(util.Iterables.lazyFilter<xml.XmlNode, xml.XmlElement>(nodes, typeof(xml.XmlElement)), new StatefulBodyXmlReader__Anonymous_5(this));
        }
        ...
        {
            var pattern = java.util.regex.Pattern.compile("\\s*HYPERLINK \"(.*)\"");
        ...
        {
            return readVal(properties, styleTagName).map(new StatefulBodyXmlReader__Anonymous_9(this, styleType, findStyleById)).orElse(results.InternalResult.empty());
        }
        public results.InternalResult<Mammoth.Couscous.java.util.Optional<documents.Style>> findStyleById(string styleType, string styleId, Mammoth.Couscous.java.util.function.Function<string, Mammoth.Couscous.java.util.Optional<documents.Style>> findStyleById)
        {
            ...
            if (style.isPresent())
            {
                return results.InternalResult.success(style);
            }
            else
            {
                return new results.InternalResult<Mammoth.Couscous.java.util.Optional<documents.Style>>(java.util.Optional.of(new documents.Style(styleId, java.util.Optional.empty<string>())), util.Lists.list($"{styleType} style with ID {styleId} was referenced but not defined in the document"));
            }
        }
        public Mammoth.Couscous.java.util.Optional<documents.NumberingLevel> readNumbering(xml.XmlElementLike properties)
        {
            ...
            return util.Optionals.flatMap(readVal(numberingProperties, "w:numId"), readVal(numberingProperties, "w:ilvl"), new StatefulBodyXmlReader__Anonymous_10(this));
        }
        public documents.ParagraphIndent readParagraphIndent(xml.XmlElementLike properties)
        {
            ...
            return new documents.ParagraphIndent(util.Optionals.first(indent.getAttributeOrNone("w:start"), indent.getAttributeOrNone("w:left")), util.Optionals.first(indent.getAttributeOrNone("w:end"), indent.getAttributeOrNone("w:right")), indent.getAttributeOrNone("w:firstLine"), indent.getAttributeOrNone("w:hanging"));
        }
        ...
        public ReadResult calculateRowspans(Mammoth.Couscous.java.util.List<documents.DocumentElement> rows)
        {
            ...
            Mammoth.Couscous.java.util.Map<int, Mammoth.Couscous.java.util.Map__Entry<int, int>> lastCellForColumn = new Mammoth.Couscous.java.util.HashMap<int, Mammoth.Couscous.java.util.Map__Entry<int, int>>();
            {
                ...
                {
                    var row = (documents.TableRow)rows.get(rowIndex);
                    var columnIndex = 0;
                    {
                        var cellIndex = 0;
                        while (cellIndex < row.getChildren().size())
                        {
                            ...
                            var spanningCell = util.Maps.lookup(lastCellForColumn, columnIndex);
                            var position = util.Maps.entry(rowIndex, cellIndex);
                            if (cell._vmerge && spanningCell.isPresent())
                            {
                                rowspans.put(spanningCell.get(), util.Maps.lookup(rowspans, spanningCell.get()).get() + 1);
                                merged.add(position);
                            }
                            else
                            {
            ...
            return ReadResult.success(util.Lists.eagerMapWithIndex(rows, new StatefulBodyXmlReader__Anonymous_14(merged, rowspans)));
        }
        ...
        {
            {
                ...
                while (_couscous_desugar_foreach_to_for2.hasNext())
                {
                    ...
                    var row = util.Casts.tryCast<documents.TableRow>(typeof(documents.TableRow), rowElement);
                    if (!row.isPresent())
                    {
                        return java.util.Optional.of("unexpected non-row element in table, cell merging may be incorrect");
                    }
                    else
                    {
                        {
                            ...
                            while (_couscous_desugar_foreach_to_for1.hasNext())
                            {
                                ...
                                {
                                    return java.util.Optional.of("unexpected non-cell element in table row, cell merging may be incorrect");
                                }
                            }
                        }
                    }
        ...
        public ReadResult readInline(xml.XmlElement element)
        {
            ...
            var altText = util.Optionals.first(properties.getAttributeOrNone("descr").filter(new StatefulBodyXmlReader__Anonymous_26()), properties.getAttributeOrNone("title"));
        ...
        public ReadResult readImage(string imagePath, Mammoth.Couscous.java.util.Optional<string> altText, util.InputStreamSupplier open)
        {
            ...
            var image = new documents.Image(altText, contentType, open);
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class StatefulBodyXmlReader__Anonymous_14 : Mammoth.Couscous.java.util.function.BiFunction<int, documents.DocumentElement, documents.DocumentElement>
    {
        ...
        {
            var row = (documents.TableRow)rowElement;
            Mammoth.Couscous.java.util.List<documents.DocumentElement> mergedCells = new Mammoth.Couscous.java.util.ArrayList<documents.DocumentElement>();
            {
                ...
                while (cellIndex < row.getChildren().size())
                {
                    ...
                    {
                        mergedCells.add(new documents.TableCell(util.Maps.lookup(_rowspans, position).get(), cell._colspan, cell._children));
                    }
                    cellIndex = cellIndex + 1;
                }
            }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.docx
{
    internal class StylesXml
    {
        ...
        {
            return util.Maps.toMap(util.Iterables.lazyFilter(styleElements, new StylesXml__Anonymous_0(styleType)), new StylesXml__Anonymous_1());
        }
        public static Mammoth.Couscous.java.util.Map__Entry<string, documents.Style> readStyle(xml.XmlElement element)
        {
            ...
            return util.Maps.entry(styleId, new documents.Style(styleId, styleName));
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.html
{
    internal class Html
    {
        ...
        {
            return new HtmlElement(new HtmlTag(util.Lists.list(tagName), attributes, false, ""), children);
        }
        public static HtmlNode collapsibleElement(string tagName)
        {
            return collapsibleElement(util.Lists.list(tagName));
        }
        ...
        {
            return collapsibleElement(util.Lists.list(tagName), attributes, children);
        }
        ...
        {
            return util.Lists.eagerFlatMap(nodes, new Html__Anonymous_1());
        }
        ...
        {
            return util.Optionals.map(util.Lists.tryGetLast(collapsed).flatMap(new Html__Anonymous_4()), util.Casts.tryCast<HtmlElement>(typeof(HtmlElement), node), new Html__Anonymous_5()).orElse(false);
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.html
{
    internal class HtmlElement : HtmlNode
    {
        ...
        static HtmlElement()
        {
            _VOID_TAG_NAMES = util.Sets.set(new string[]
            {
                "img",
                "br",
                "hr"
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.html
{
    internal class HtmlWriter
    {
        ...
        {
            {
                var _couscous_desugar_foreach_to_for5 = util.Lists.orderedBy(attributes.entrySet(), new HtmlWriter__Anonymous_2()).iterator();
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.results
{
    internal static class InternalResult
    {
        ...
        {
            var results = util.Lists.eagerMap(iterable, function);
            return new InternalResult<Mammoth.Couscous.java.util.List<R>>(util.Lists.eagerMap(results, new InternalResult__Anonymous_0<R>()), util.Iterables.lazyFlatMap(results, new InternalResult__Anonymous_1<R>()));
        }
        public static InternalResult<R> flatMap<T1, T2, R>(InternalResult<T1> first, InternalResult<T2> second, Mammoth.Couscous.java.util.function.BiFunction<T1, T2, InternalResult<R>> function)
        {
            ...
            return new InternalResult<R>(intermediateResult._value, util.Iterables.lazyConcat(util.Iterables.lazyConcat(first._warnings, second._warnings), intermediateResult._warnings));
        }
        ...
        {
            return new InternalResult<R>(function.apply(first._value, second._value), util.Iterables.lazyConcat(first._warnings, second._warnings));
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.results
{
    internal class InternalResult<T>
    {
        ...
        public InternalResult<R> flatMap<R>(Mammoth.Couscous.java.util.function.Function<T, InternalResult<R>> function)
        {
            ...
            return new InternalResult<R>(intermediateResult._value, util.Iterables.lazyConcat(_warnings, intermediateResult._warnings));
        }
        public Result<T> toResult()
        {
            var warnings = util.Sets.toSet(_warnings);
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles
{
    internal class DefaultStyles
    {
        ...
        {
            _DEFAULT_STYLE_MAP = parsing.StyleMapParser.parseStyleMappings(util.Lists.list(new string[]
            {
                "p.Heading1 => h1:fresh",
                "p.Heading2 => h2:fresh",
                "p.Heading3 => h3:fresh",
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles
{
    internal class HtmlPath_static
    {
        ...
        {
            return new HtmlPathElements(java.util.Arrays.asList(elements));
        }
        ...
        {
            var tag = new html.HtmlTag(util.Lists.list(tagName), attributes, false, "");
            return new HtmlPathElements(util.Lists.list(new HtmlPathElement(tag)));
        }
        ...
        {
            return collapsibleElement(util.Lists.list(tagName), attributes);
        }
        ...
        {
            var tag = new html.HtmlTag(tagNames, attributes, true, "");
            return new HtmlPathElements(util.Lists.list(new HtmlPathElement(tag)));
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles
{
    internal class HtmlPathElements : HtmlPath
    {
        ...
        {
            {
                var _couscous_desugar_foreach_to_for6 = util.Lists.reversed(_elements).iterator();
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles
{
    internal class ParagraphMatcher : DocumentElementMatcher<documents.Paragraph>
    {
        ...
        {
            return new ParagraphMatcher(java.util.Optional.of(styleId), java.util.Optional.empty<StringMatcher>(), java.util.Optional.empty<documents.NumberingLevel>());
        }
        ...
        {
            return new ParagraphMatcher(java.util.Optional.empty<string>(), java.util.Optional.of(styleName), java.util.Optional.empty<documents.NumberingLevel>());
        }
        public static ParagraphMatcher orderedList(string level)
        {
            return new ParagraphMatcher(java.util.Optional.empty<string>(), java.util.Optional.empty<StringMatcher>(), java.util.Optional.of(documents.NumberingLevel.ordered(level)));
        }
        public static ParagraphMatcher unorderedList(string level)
        {
            return new ParagraphMatcher(java.util.Optional.empty<string>(), java.util.Optional.empty<StringMatcher>(), java.util.Optional.of(documents.NumberingLevel.unordered(level)));
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles
{
    internal class RunMatcher : DocumentElementMatcher<documents.Run>
    {
        ...
        {
            return new RunMatcher(java.util.Optional.of(styleId), java.util.Optional.empty<StringMatcher>());
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles
{
    internal class StyleMap
    {
        ...
        {
            return new StyleMap(util.Optionals.first(high._bold, low._bold), util.Optionals.first(high._italic, low._italic), util.Optionals.first(high._underline, low._underline), util.Optionals.first(high._strikethrough, low._strikethrough), util.Optionals.first(high._smallCaps, low._smallCaps), util.Optionals.first(high._commentReference, low._commentReference), util.Lists.eagerConcat(high._paragraphStyles, low._paragraphStyles), util.Lists.eagerConcat(high._runStyles, low._runStyles), util.Lists.eagerConcat(high._tableStyles, low._tableStyles), util.Lists.eagerConcat(high._breakStyles, low._breakStyles));
        }
        ...
        {
            return util.Iterables.tryFind(_paragraphStyles, new StyleMap__Anonymous_0(paragraph)).map(new StyleMap__Anonymous_1());
        }
        public Mammoth.Couscous.java.util.Optional<HtmlPath> getRunHtmlPath(documents.Run run)
        {
            return util.Iterables.tryFind(_runStyles, new StyleMap__Anonymous_2(run)).map(new StyleMap__Anonymous_3());
        }
        public Mammoth.Couscous.java.util.Optional<HtmlPath> getTableHtmlPath(documents.Table table)
        {
            return util.Iterables.tryFind(_tableStyles, new StyleMap__Anonymous_4(table)).map(new StyleMap__Anonymous_5());
        }
        public Mammoth.Couscous.java.util.Optional<HtmlPath> getBreakHtmlPath(documents.Break breakElement)
        {
            return util.Iterables.tryFind(_breakStyles, new StyleMap__Anonymous_6(breakElement)).map(new StyleMap__Anonymous_7());
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles
{
    internal class TableMatcher : DocumentElementMatcher<documents.Table>
    {
        ...
        {
            return new TableMatcher(java.util.Optional.of(styleId), java.util.Optional.empty<StringMatcher>());
        }
    ...
    internal class DocumentMatcherParser
    {
        ...
        public static Mammoth.Couscous.java.util.Optional<StringMatcher> parseStyleName(TokenIterator<TokenType> tokens)
        {
            if (tokens.trySkip(TokenType._SYMBOL, "["))
            {
                ...
                return java.util.Optional.of(stringMatcher);
            }
            else
            {
        ...
        public static Mammoth.Couscous.java.util.Optional<documents.NumberingLevel> parseNumbering(TokenIterator<TokenType> tokens)
        {
            if (tokens.trySkip(TokenType._SYMBOL, ":"))
            {
                ...
                tokens.skip(TokenType._SYMBOL, "(");
                var level = new java.math.BigInteger(tokens.nextValue(TokenType._INTEGER)).subtract(java.math.BigInteger._ONE).toString();
                tokens.skip(TokenType._SYMBOL, ")");
                return java.util.Optional.of(new documents.NumberingLevel(level, isOrdered));
            }
            else
            {
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles.parsing
{
    internal class EscapeSequences
    {
        ...
        public static string decode(string value)
        {
            ...
            var decoded = new java.lang.StringBuilder();
            var lastIndex = 0;
            while (matcher.find())
            {
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles.parsing
{
    internal class HtmlPathParser
    {
        ...
        public static HtmlPathElement parseElement(TokenIterator<TokenType> tokens)
        {
            ...
            var attributes = classNames.isEmpty() ? util.Maps.map<string, string>() : util.Maps.map("class", java.lang.String.join(" ", classNames));
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles.parsing
{
    internal class RegexTokeniser<T>
    {
        ...
        internal RegexTokeniser(T unknown, Mammoth.Couscous.java.util.List<RegexTokeniser__TokenRule<T>> rules)
        {
            ...
            _pattern = java.util.regex.Pattern.compile(java.lang.String.join("|", util.Iterables.lazyMap(allRules, new RegexTokeniser__Anonymous_0<T>())));
            _rules = util.Lists.eagerMap(allRules, new RegexTokeniser__Anonymous_1<T>());
        }
        public Mammoth.Couscous.java.util.List<Token<T>> tokenise(string value)
        {
            ...
            {
                var groupIndex = util.Iterables.tryFind(util.Iterables.intRange(0, _rules.size()), new RegexTokeniser__Anonymous_2(matcher));
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles.parsing
{
    internal class StyleMapParser
    {
        ...
        {
            return parseStyleMappings(java.util.Arrays.asList(input.split("\\r?\\n")));
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles.parsing
{
    internal class StyleMappingTokeniser
    {
        ...
        public static Mammoth.Couscous.java.util.List<Token<TokenType>> tokeniseToList(string line)
        {
            ...
            var tokeniser = new RegexTokeniser<TokenType>(TokenType._UNKNOWN, util.Lists.list(new RegexTokeniser__TokenRule<TokenType>[]
            {
                RegexTokeniser.rule(TokenType._IDENTIFIER, $"{identifierCharacter}(?:{identifierCharacter}|[0-9])*"),
                RegexTokeniser.rule(TokenType._SYMBOL, ":|>|=>|\\^=|=|\\(|\\)|\\[|\\]|\\||!|\\."),
                RegexTokeniser.rule(TokenType._WHITESPACE, "\\s+"),
                RegexTokeniser.rule(TokenType._STRING, $"{stringPrefix}'"),
                RegexTokeniser.rule(TokenType._UNTERMINATED_STRING, stringPrefix),
                RegexTokeniser.rule(TokenType._INTEGER, "[0-9]+")
            }));
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.styles.parsing
{
    internal class TokenParser
    {
        public static Mammoth.Couscous.java.util.Optional<string> parseClassName(TokenIterator<TokenType> tokens)
        {
            if (tokens.trySkip(TokenType._SYMBOL, "."))
            {
                return java.util.Optional.of(parseIdentifier(tokens));
            }
            else
            {
                return java.util.Optional.empty<string>();
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.util
{
    internal class Optionals
    {
        ...
        public static Mammoth.Couscous.java.util.Optional<R> map<T1, T2, R>(Mammoth.Couscous.java.util.Optional<T1> first, Mammoth.Couscous.java.util.Optional<T2> second, Mammoth.Couscous.java.util.function.BiFunction<T1, T2, R> function)
        {
            if (first.isPresent() && second.isPresent())
            {
                return java.util.Optional.of(function.apply(first.get(), second.get()));
            }
            else
            {
                return java.util.Optional.empty<R>();
        ...
        public static Mammoth.Couscous.java.util.Optional<R> map<R>(Mammoth.Couscous.java.util.OptionalInt first, Mammoth.Couscous.java.util.function.IntFunction<R> function)
        {
            if (first.isPresent())
            {
                return java.util.Optional.of(function.apply(first.getAsInt()));
            }
            else
            {
                return java.util.Optional.empty<R>();
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.xml
{
    internal class NamespacePrefixes : java.lang.Iterable<NamespacePrefix>
    {
        ...
        {
            return util.Maps.lookup(_uriToPrefix, uri);
        }
        public Mammoth.Couscous.java.util.Optional<NamespacePrefix> lookupPrefix(string prefix)
        {
            return lookupPrefix(java.util.Optional.of(prefix));
        }
        ...
        {
            return util.Iterables.tryFind(_uriToPrefix.values(), new NamespacePrefixes__Anonymous_0(prefix));
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.xml
{
    internal class NamespacePrefixes__Builder
    {
        ...
        {
            _uriToPrefix.put(uri, new NamespacePrefix(java.util.Optional.of(prefix), uri));
            return this;
        }
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.xml
{
    internal class XmlElement : XmlNode, XmlElementLike
    {
        ...
        public Mammoth.Couscous.java.util.Optional<string> getAttributeOrNone(string name)
        {
            return util.Maps.lookup(_attributes, name);
        }
        public string innerText()
        {
            return java.lang.String.join("", util.Iterables.lazyMap(_children, new XmlElement__Anonymous_1()));
        }
        ...
        {
            return new XmlElementList(util.Lists.toList(findChildrenIterable(name)));
        }
        public Mammoth.Couscous.java.util.Optional<XmlElement> findChild(string name)
        {
            return util.Iterables.getFirst(findChildrenIterable(name));
        }
        public bool hasChild(string name)
        {
        ...
        public XmlElementLike findChildOrEmpty(string name)
        {
            return util.Iterables.getFirst(findChildrenIterable(name), NullXmlElement._INSTANCE);
        }
        public java.lang.Iterable<XmlElement> findChildrenIterable(string name)
        {
            return util.Iterables.lazyFilter(util.Iterables.lazyFilter<XmlNode, XmlElement>(_children, typeof(XmlElement)), new XmlElement__Anonymous_2(name));
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.xml
{
    internal class XmlElementList : java.lang.Iterable<XmlElement>
    {
        ...
        public XmlElementList findChildren(string name)
        {
            return new XmlElementList(util.Lists.eagerFlatMap(_elements, new XmlElementList__Anonymous_0(name)));
        }
    }
}
...
namespace Mammoth.Couscous.org.zwobble.mammoth.@internal.xml.parsing
{
    internal class XmlParser__NodeGenerator : SimpleSaxHandler
    {
        ...
        {
            var simpleAttributes = util.Maps.eagerMapKeys(attributes, new XmlParser__Anonymous_0(this));
